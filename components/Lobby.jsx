...
const Lobby = () => {
  ...
  const setName = getName((state) => state.setName);
  ...
  return (
    <div className="bg-[#1c1c1c] h-screen flex justify-center items-center">
      <div className="bg-[#1e293b] rounded-xl p-5 pb-9  px-7 md:w-[30%] shadow-md flex flex-col items-center gap-6">
        <p className="text-3xl text-white font-bold py-5">
          <span className="text-[#ff6452]">Meet</span> and Streaming
        </p>
        ...
        <div className="flex w-full justify-center items-center gap-3">
          ...
          <button
            onClick={joinRoom}
            className="bg-[#ff6452] text-white rounded-md px-4 py-2 hover:scale-105 transition duration-200"
          >
            Join Room
          </button>
        </div>
        ...
        <button
          ...
          className="bg-[rgb(255,100,82)] text-white rounded-md px-8 py-2 hover:scale-105 transition duration-200"
        >
          Create new Room
        </button>
      </div>
